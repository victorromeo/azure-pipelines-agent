...
try {
 $null = Add-CapabilityFromRegistryWithLastVersionAvailable -Name 'java_9_and_greater_x64' -Hive 'LocalMachine' -View 'Registry64' -KeyName $jdk9AndGreaterName -ValueName 'JavaHome' -Value ([ref]$latestJre)
} catch {
...
try {
 $null = Add-CapabilityFromRegistryWithLastVersionAvailable -Name 'jdk_9_and_greater_x64' -Hive 'LocalMachine' -View 'Registry64' -KeyName $jdk9AndGreaterName -ValueName 'JavaHome' -Value ([ref]$latestJdk)
} catch {
