...
namespace Microsoft.VisualStudio.Services.Agent
{
    ...
    public interface IJobServer : IAgentService
    {
        ...
        Task<(DedupIdentifier dedupId, ulong length, TimelineRecordAttachmentTelemetryRecord record)> UploadAttachmentToBlobStore(bool verbose, string itemPath, Guid planId, Guid jobId, CancellationToken cancellationToken);
    }
    ...
    public sealed class JobServer : AgentService, IJobServer
    {
        ...
        public async Task<(DedupIdentifier dedupId, ulong length, TimelineRecordAttachmentTelemetryRecord record)> UploadAttachmentToBlobStore(bool verbose, string itemPath, Guid planId, Guid jobId, CancellationToken cancellationToken)
        {
            ...
            var results = await BlobStoreUtils.UploadToBlobStore<TimelineRecordAttachmentTelemetryRecord>(verbose, itemPath, (level, uri, type) =>
